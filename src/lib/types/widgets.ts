...
export const DEFAULT_WIDGET_CONFIGS: WidgetConfig[] = [
  ...
  { id: "w4", type: "recent-errors", title: "Recent errors", size: "large", order: 4, enabled: true },
  { id: "w5", type: "top-error-messages", title: "Top error messages", size: "large", order: 5, enabled: true },
