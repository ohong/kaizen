        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-[var(--hud-text-dim)]">
              Tune the survey before it goes live, then review AI-generated insights that summarize what your engineers are saying.
            </p>
          </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <div className="hud-panel hud-corner border border-[var(--hud-border)] bg-[var(--hud-bg)]/90 p-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <span className="rounded-full border border-[var(--hud-accent)] px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-[var(--hud-accent)]">
              Updated 2h ago
            </span>
          </div>
