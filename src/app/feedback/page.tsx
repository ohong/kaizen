...
export default function FeedbackPage() {
  ...
  const [surveyData, setSurveyData] = useState<SurveyData>({
    ...
    message:
      "We'd love to hear your feedback on your development experience with our team. Your insights help us continuously improve our processes, tools, and collaboration.",
  });
      ...
      <main className="mx-auto max-w-[1200px] px-8 py-12">
        ...
        <section className="hud-panel hud-corner hud-scanline mb-10 p-8">
          <div className="flex items-center justify-between">
            ...
            >
              {showComposer ? "Hide Insights" : "View Insights"}
            </button>
          </div>
        </section>
        ...
        {showComposer && (
          <div className="mb-10">
            <FeedbackComposer
              ...
              defaultBody="We're running a quick pulse check to understand how our AI-assisted development workflow is landing with the team. Your honest feedback helps us tune tools, processes, and support to match what you actually need day-to-day."
            />
          </div>
        )}
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {sendResult.details && sendResult.details.successful && (
                  <div className="mt-3">
                ...
                {sendResult.details && sendResult.details.failed && sendResult.details.failed.length > 0 && (
                  <div className="mt-3">
